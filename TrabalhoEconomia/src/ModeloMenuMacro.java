 ...
 * @author Thiago_NB
 */
public class ModeloMenuMacro extends javax.swing.JFrame {

    private String[] listaAssuntos;
    /**
     * Creates new form JanelaInicial
     */
    public ModeloMenuMacro(ArrayList<String> listaAssuntos ) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Assuntos macroeconomia");
        ...
        btnIrQuestao.setName("macro"); // NOI18N
        ...
        btnVoltar.setName("macro"); // NOI18N
    ...
    private void btnIrQuestaoActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        if (TrabalhoEconomia.questoesMacro.containsKey(titulo)){
            Questoes q = TrabalhoEconomia.questoesMacro.get(titulo);
